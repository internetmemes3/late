        ...
        <div className="flex flex-col md:flex-row items-center justify-center ">
          ...
          <h1 className="text-5xl font-bold text-white leading-tight nabla-hero-title">
            ...
            <div className="mt-6 flex space-x-4">
              <a className="bg-yellow-400 text-black text-primary-foreground px-4 py-2 rounded-lg hover:bg-primary/80"  href="https://four.meme/token/0x1a5879fe551d15e1e5eaf3b9900f935f0b474444" target="_blank" >$LATECOIN</a>
