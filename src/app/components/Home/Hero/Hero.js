        ...
        <div className="flex flex-col md:flex-row items-center justify-center ">
          ...
          <h1 className="text-5xl font-bold text-white leading-tight nabla-hero-title">
            ...
            <div className="mt-6 flex space-x-4">
              <a className="bg-yellow-400 text-white text-primary-foreground px-4 py-2 rounded-lg hover:bg-primary/80"  href="https://pump.fun/board" target="_blank" >$LATECOIN</a>
              <a className="text-gray-200 border border-gray-500 text-secondary-foreground px-4 py-2 rounded-lg hover:bg-secondary/80" href="https://t.me/latecoinsol" target="_blank" >Join Community</a>
            </div>
          </div>
